...
static const building_type MENU_BUILDING_TYPE[BUILD_MENU_MAX][BUILD_MENU_ITEM_MAX] = {
    ...
    {BUILDING_MENU_GARDENS, BUILDING_MENU_TREES, BUILDING_MENU_PATHS, BUILDING_MENU_PARKS, BUILDING_MENU_STATUES,
        ...
        BUILDING_PRAETORIUM_MAGNUM, BUILDING_TRIUMPHAL_ARCH, 0},
    ...
    {BUILDING_MENU_FARMS, BUILDING_MENU_RAW_MATERIALS, BUILDING_MENU_WORKSHOPS,
        BUILDING_MARKET, BUILDING_GRANARY, BUILDING_WAREHOUSE, BUILDING_DEPOT, BUILDING_CARAVANSERAI, BUILDING_PORTORIUM, 0},
