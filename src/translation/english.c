...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_PRAETORIUM_MAGNUM_DESC, "Praetorium Magnum governs imperial administration. With a full staff it grants +12% tax income, +5 yearly Favor drift, and -10% import prices across all trade routes."},
    {TR_BUILDING_PRAETORIUM_MAGNUM_PHASE_1, "(Foundations)"},
    {TR_BUILDING_PRAETORIUM_MAGNUM_PHASE_2, "(State Halls)"},
    {TR_BUILDING_PRAETORIUM_MAGNUM_PHASE_3, "(Administrative Wing)"},
    {TR_BUILDING_PRAETORIUM_MAGNUM_PHASE_4, "(Grand Facade)"},
    {TR_BUILDING_PRAETORIUM_MAGNUM_PHASE_1_TEXT, "Engineers and laborers are laying a broad stone foundation and timber frame for the imperial complex."},
    {TR_BUILDING_PRAETORIUM_MAGNUM_PHASE_2_TEXT, "Masons and smiths are raising the great halls where magistrates and envoys will gather."},
    {TR_BUILDING_PRAETORIUM_MAGNUM_PHASE_3_TEXT, "Artisans are fitting the administrative wing with furnishings, armories, and ceremonial stores."},
    {TR_BUILDING_PRAETORIUM_MAGNUM_PHASE_4_TEXT, "The final marble frontage is being completed, preparing the Praetorium Magnum for formal dedication."},
    ...
    {TR_CITY_WARNING_PRAETORIUM_REQUIREMENTS, "Praetorium Magnum requires: Senate, Work Camp, Architects' Guild, population 10,000, Culture 55, Prosperity 60, Peace 70."},
